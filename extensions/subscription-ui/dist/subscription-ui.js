...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/subscription-ui/src/index.jsx
  ...
  // node_modules/@shopify/admin-ui-extensions/node_modules/@remote-ui/core/build/esm/component.mjs
  ...
  function useLocale() {
    ...
    const [locale, setLocale] = (0, import_react8.useState)(initialValue);
  ...
  // extensions/subscription-ui/src/components/Remove.jsx
  var import_react9 = __toESM(require_react());

  // extensions/subscription-ui/src/utils/fetchApi.jsx
  var fetchApi = (_0, ..._1) => __async(void 0, [_0, ..._1], function* (url, options = {}) {
    try {
  ...
  function Remove() {
    ...
    const localizedStrings = (0, import_react9.useMemo)(() => {
    ...
    (0, import_react9.useEffect)(() => {
      setPrimaryAction({
        ...
        onAction: () => __async(this, null, function* () {
          ...
          const url = "https://testuat-sim.zugdev.com/StorePreOrderProduct/RemoveProductFromSellingPlanGroup";
          const options = {
            method: "POST",
            headers: {
          ...
          try {
            yield fetchApi_default(url, options);
            done();
          } catch (error) {
  ...
  extend(
    ...
    render2(() => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Remove_default, {}))
  );
})();
